### Set Work directory
setwd('C:/Users/User/Desktop/2018_Subduction zone earthquakes_research/201807_thesis/SA/¤p¸­Âoªiµ{¦¡/07_SGM/')
...
data.all <- read.table("Âoªi³æ/filter2016_yang.txt",header=T)
...
ProcessTH <- function(SGM_SN, author, Baseline=TRUE, PreBaseline=FALSE, Skip=0, Add=20, Taper=0, nDC=2000, tb=5, te=5, nPole=2) {
  ...
  #CHECK¦s©ñÂoªiÀW¬q¤å¦rÀÉ¦ì¸m¬O§_¦s¦b
  path9 <- paste("PROCESS_FILE_¼È©ñ/TXT",sep="")
