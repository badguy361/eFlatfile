...
for (i in 1:3){
  ...
  fc <- sort(fc$x) # locator() 會回傳點擊的x及y座標
  #fc <- c(0.1,25) #固定頻段濾波
...
#####
#load("C:/Users/User/Desktop/計畫相關資料/小葉計畫教學_強地動加值資料庫/07_SGM/jan_to_jun2016.RData")
#cal <- sgm.all[c("HP_V","LP_V","HP_NS","LP_NS","HP_EW","LP_EW")]