# 2011/10 Brian提供的新版,應該不會有亂跳動的情形再發生

spectraw2 <- function(acc, damping, pdata="") 
{
	period.dat <- scan("C:/Users/user/Desktop/meinon/SGM_Process/period.dat", skip=1)
...
## 	
	if (!is.loaded('rsp')) dyn.load("C:/Users/user/Desktop/meinon/SGM_Process/dll/rsp_new.dll")
...
#						    				 as.double(z) #, as.double(rd), as.double(rv), as.double(aa)
  ...
  if (is.loaded('rsp')) dyn.unload("C:/Users/user/Desktop/meinon/SGM_Process/dll/rsp_new.dll")
